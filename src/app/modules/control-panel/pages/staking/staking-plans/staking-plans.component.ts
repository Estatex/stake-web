...
@Component({
    selector: 'app-staking-plans',
    templateUrl: './staking-plans.component.html',
    styleUrls: ['./staking-plans.component.scss']
})

export class StakingPlansComponent implements OnInit {
        pageData:any;
